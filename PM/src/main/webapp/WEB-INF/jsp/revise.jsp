...
<div class="pofol_upload">
	<div class="sub_tit">
		...
		포트폴리오 평가
		<button class="btn revise" id="btn_revise">저장</button><!-- data-dialog="revise_save" -->
	</div>
	<form name="revise" id="fileForm" action="" method="" enctype="multipart/form-data">
		<input type="hidden" name="no" value="<%=(String)request.getParameter("no")%>">
		<input type="hidden" name="_id" value="<%=(String)request.getParameter("no")%>">
		<input class="status" type="hidden" name="status" value="">
		<input class="_enterprise" type="hidden" name="_enterprise" value="">
		<input class="score" type="hidden" name="score" value="">
		<input class="professorSignature" type="hidden" name="professorSignature" value="">
		<input class="studentSignature" type="hidden" name="studentSignature" value="">
		<input class="complain" type="hidden" name="complain" value="">
		<input class="blockchainHashcode" type="hidden" name="blockchainHashcode" value="">
		...
		<ul>
			<li class="w50">
				...
				<div>
					<label>
						<input class="group_type" type="radio" value="personal" name="type">개인
					</label>
					<label>
						<input class="group_type" type="radio" value="group" name="type">그룹
					</label>
				</div>
			</li>
			<li class="w50">
			...
			<li class="w100">
				...
				<button class="btn br_0 " id="start_button"><i class="ri-mic-line"></i></button>
			</li>
			<li class="w100">
				<p>기간</p>
				<div>
					<input type="date" name="startDate" placeholder="시작일" id="startDate" class="hasDatepicker mr_20" >
					<input type="date" name="endDate" placeholder="종료일" id="endDate" class="hasDatepicker" >
				</div>
			</li>
			<li class="w100 sp" style="height:100%;display:contents;">
				<!-- <textarea rows="20" cols="2000" placeholder="내용을 입력해주세요." id="se2"  rows="10" cols="100"  style='width:100%; min-width:260px;display:none;'></textarea> -->
				<!-- 
			...
			<li class="w100">
				<p>파일</br>첨부</p>
				<input type="text" id="fileName_2" name="fileName" class="file_name"></span>
				<input type="file" id="file_upload_2" name="file" onchange="javascript:document.getElementById('fileName_2').value = this.value.split('\\')[this.value.split('\\').length-1]">
				<label for="file_upload_2" class="btn">파일첨부</label>
				<button class="btn reset">첨부초기화</button>
			</li>
			<!-- 
			<li class="w100 disabled" >
				<p>평가</br>점수</p>
				<div> 
					<span class="score"></span>
					<button class="btn apply">이의신청</button>
				</div>
			</li>
			 -->
			<!-- <li class="w100">
				<a href="#" class="re_btn"><button class="btn">수정하기</button></a>
			</li> -->
		</ul>
	</form>
</div>
...
<!-- 
<div id="revise_save" class="dialog">	
	<div class="dialog__overlay"></div>	
...
<script type="text/javascript" src="${resourcePath}/js/revise.js"></script>