...
<div class="content am_professor">
	<form name="am_professor" action="" method="" onsubmit="" class="pos">
		...
		<div>
			<p class="title">교수목록</p>
			<div class="add_btn">
				<a href="${contextPath}/admin_sd_add?type=professor" class="am_bg_point"><i class="ri-add-line"></i>데이터 추가</a>
			</div>
		</div>
		<div class="search">
...
<script type="text/javascript" src="${resourcePath}/js/admin_professor.js"></script>