...
<div class="content am_student ">
	<form name="am_student" action="" method="" onsubmit="" class="pos">
		...
		<div>
			<p class="title">학생목록</p>
			<div class="add_btn">
				<a href="${contextPath}/admin_sd_add?type=student" class="am_bg_point"><i class="ri-add-line"></i>데이터 추가</a>
			</div>
		</div>
		<div class="search">
...
<script type="text/javascript" src="${resourcePath}/js/admin_student.js"></script>
